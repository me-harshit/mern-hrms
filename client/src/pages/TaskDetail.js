...
import {
    ...
    faCheckCircle, faCalendarAlt, faUserTie, faEdit, faPlus, faBuilding
            ...
            <div className="td-layout">
                ...
                <aside className="td-side">
                            ...
                            <div className="assignee-chip-list">
                                {task.assignees.map(a => (
                                    <div key={a._id} className={`assignee-chip ${a._id === currentUserId ? 'is-me' : ''}`}>
                                        <div className="assignee-avatar">{initials(a.name)}</div>
                    ...
                    {task.completionProof?.length > 0 && (
                        <section className="td-panel">
                            <header className="td-panel-head">
                                <h2><FontAwesomeIcon icon={faCheckCircle} /> Completion proof</h2>
