                ...
                <div className="fade-in d-block">
                    <form onSubmit={handleUpdateProfile}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
                            ...
                            <div className="form-group"><label className="input-label">WhatsApp Number</label><input className="custom-input" placeholder="Leave blank to use the phone number" value={user.whatsappNumber || ''} onChange={e => setUser({ ...user, whatsappNumber: e.target.value })} /></div>
                            <div className="form-group"><label className="input-label">WhatsApp Notifications</label><select className="custom-input" value={user.whatsappNotificationsEnabled === false ? 'off' : 'on'} onChange={e => setUser({ ...user, whatsappNotificationsEnabled: e.target.value === 'on' })}><option value="on">Enabled</option><option value="off">Opted out</option></select></div>
